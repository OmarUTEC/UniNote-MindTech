...
function App() {
  ...
  return (
    <div className={`flex flex-col h-screen ${theme.backgroundColor} ${theme.textColor}`}>
      <div className={`${theme.navColor} ${theme.navTextColor} py-2 px-2 flex justify-between items-center fixed top-0 left-0 right-0 z-10`}>
      ...
      <div className="flex flex-1 pt-16">
        <div className={`${theme.navColor} w-56 p-4 mt-2 rounded-lg fixed top-16 left-0 bottom-0 z-10`}>

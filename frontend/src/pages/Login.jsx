      ...
      <div className={`shadow-md rounded px-8 pt-6 pb-8 mb-4 ${darkMode ? 'bg-gray-800' : 'bg-white'}`}>
        ...
        <form>
          <div className="mb-4">
            ...
            <input className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${darkMode ? 'bg-gray-700 text-white' : 'bg-white'}`} id="username" type="text" placeholder="Usuario" />
          </div>

          <div className="mb-6 relative">
            <label className={`block text-sm font-bold mb-2 ${darkMode ? 'text-white' : 'text-gray-700'}`} htmlFor="password">Contraseña</label>
            <input className={`shadow appearance-none border rounded w-full py-2 px-3 mb-3 leading-tight focus:outline-none focus:shadow-outline ${darkMode ? 'bg-gray-700 text-white' : 'bg-white'}`} id="password" type="password" placeholder="******************" />
          ...
          <div className="flex flex-col space-y-2">
            <a href="http://127.0.0.1:5000/login-google" className="w-full">
              <button className={`bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline ${darkMode ? 'bg-gray-600' : ''}`} type="button">Iniciar sesión con Google</button>
            </a>
